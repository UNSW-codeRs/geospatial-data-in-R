...
|----------|-------|----------|---------|
| 1 | Create a spatial object | `sf`, `mapview` | [UNSW-codeRs](https://yessl3-unswcoders.shinyapps.io/tutorial-1-create-spatial-object/) / [ecosphere](https://ecosphere.shinyapps.io/tutorial-1-create-spatial-object/) |
| 2 | Points, lines and polygons | `sf`, `mapview` | [UNSW-codeRs](https://yessl3-unswcoders.shinyapps.io/tutorial-2-points-lines-polygons/) / [ecosphere]( https://ecosphere.shinyapps.io/tutorial-2-points-lines-polygons/)|
| 3 | Thematic mapping | `sf`, `tmap` | [ecosphere](https://ecosphere.shinyapps.io/tutorial-3-thematic-map/) |
| 4 | Geostatistic analysis | `sf`, `sp`, `raster`, `gstat` | work in progress |
