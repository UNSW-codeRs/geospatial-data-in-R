...
The earth is not flat, it is *almost* a perfect sphere...
...
------------------------------------
Tutorial 1 | Create a spatial object |
`sf`, `mapview` |
[UNSW-codeRs](https://yessl3-unswcoders.shinyapps.io/tutorial-1-create-spatial-object/) |

Tutorial 2 | Points, lines and polygons |
`sf`, `mapview` |
[UNSW-codeRs](https://yessl3-unswcoders.shinyapps.io/tutorial-2-points-lines-polygons/) |

Tutorial 3 | Thematic mapping |
`sf`, `tmap` |
[UNSW-codeRs](https://yessl3-unswcoders.shinyapps.io/tutorial-2-points-lines-polygons/) |

Tutorial 4 | Geostatistic analysis |
`sf`, `sp`, `raster`, `gstat` |
[UNSW-codeRs](https://yessl3-unswcoders.shinyapps.io/tutorial-2-points-lines-polygons/) |
...
Photos by José R. Ferrer-Paris, shared under: [Attribution 4.0 Internacional (CC BY 4.0)](https://creativecommons.org/licenses/by/4.0/)
