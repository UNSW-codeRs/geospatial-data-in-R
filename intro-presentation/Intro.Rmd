...
For this workshop I have prepared several tutorials using the R packages `learnr` and `Rmarkdown`. 
...
| 3 | WIP | Thematic mapping | `sf`, `tmap` | work in progress |
| 4 | WIP | Geostatistic analysis | `sf`, `sp`, `raster`, `gstat` | work in progress |
