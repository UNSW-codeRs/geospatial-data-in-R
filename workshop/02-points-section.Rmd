...
For the rest of the tutorial we want to explore the surroundings of the University of Bayreuth, my _alma mater_.
...
Here we will select one variable from our object and use the defaul plot function for _sf_ objects:
...
- Then we want to know which one of these is nearest to our 
