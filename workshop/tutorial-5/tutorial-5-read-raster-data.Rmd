...
We use the function `wdpa_fetch` to download protected area data for Bhutan from Protected Planet. We can achieve this by specifying Bhutan’s country name or its ISO3 code (i.e. "BTN"). Data are downloaded to a temporary directory by default.
