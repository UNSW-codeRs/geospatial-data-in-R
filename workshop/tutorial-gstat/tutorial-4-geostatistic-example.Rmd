...
here::i_am("workshop/tutorial-gstat/tutorial-4-geostatistic-example.Rmd")
data_folder <- "data"
...
For this tutorial we will **read spatial objects from a file**. This file is preloaded in the learner tutorial, but if you want to replicate this steps in an R session, you need to locate the original file in the data folder of the parent repository. For example, using package `here`:
